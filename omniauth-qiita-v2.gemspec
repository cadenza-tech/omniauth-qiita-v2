...
require_relative 'lib/omniauth/qiita_v2/version'

Gem::Specification.new do |spec|
  spec.name = 'omniauth-qiita-v2'
  spec.version = OmniAuth::QiitaV2::VERSION
  spec.description = 'Qiita strategy for OmniAuth'
  spec.summary = 'Qiita strategy for OmniAuth'
  spec.authors = ['Masahiro']
  spec.email = ['watanabe@cadenza-tech.com']
  spec.license = 'MIT'

  github_root_uri = 'https://github.com/cadenza-tech/omniauth-qiita-v2'
